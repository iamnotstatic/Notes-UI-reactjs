    ...
    render() {
        return (
            ...
            <div className="homeStyle">
                <h2>Start creating note today</h2><hr></hr>
               <p className="pStyle">W3Schools is optimized for learning, testing, 
                ...
                Copyright 1999-2016 by Refsnes Data. All Rights Reserved.</p> <hr></hr>
                <p className="pStyle">W3Schools is optimized for learning, testing, 
                and training. Examples might be simplified to 
                improve reading and basic understanding. Tutorials,
                references, and examples are constantly reviewed to avoid 
